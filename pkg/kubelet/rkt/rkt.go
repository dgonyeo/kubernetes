...
func New(config *Config,
	...
	if err := rkt.checkVersion(minimumRktBinVersion, recommendRktBinVersion, minimumAppcVersion, minimumRktApiVersion, minimumSystemdVersion); err != nil {
...
func (r *Runtime) ListImages() ([]kubecontainer.Image, error) {
	ctx := context.Background()
	listReq := &rktapi.ListImagesRequest{}
	listResp, err := r.apisvc.ListImages(ctx, listReq)
	if err != nil {
